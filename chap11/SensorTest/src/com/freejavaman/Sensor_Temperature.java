...
//感溫器測試
public class Sensor_Temperature extends Activity
                                implements SensorEventListener
{
 ...
 //設定取得感溫器
 private int sensorType = Sensor.TYPE_TEMPERATURE;
 ...
 public void onSensorChanged(SensorEvent event) {
  if (event.sensor.getType() == sensorType) {
    sensorTxt.setText("目前溫度：" + event.values[0]);    
    Log.v("sensor", "result:" + event.values[0]);
  } else {
