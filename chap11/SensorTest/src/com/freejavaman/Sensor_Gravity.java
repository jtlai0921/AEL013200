...
//重力加速度測試
public class Sensor_Gravity extends Activity
                                implements SensorEventListener
{
 ...
 //設定取得重力感測器
 private int sensorType = Sensor.TYPE_GRAVITY;
 ...
 public void onSensorChanged(SensorEvent event) {
  if (event.sensor.getType() == sensorType) {
	xTxt.setText("X軸 重力加速度：" + event.values[0] + " m/s^2");
	yTxt.setText("Y軸 重力加速度：" + event.values[1] + " m/s^2");
	zTxt.setText("Z軸 重力加速度：" + event.values[2] + " m/s^2");
